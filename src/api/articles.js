...
export default {
    ...
    //获取文章详情
    allArticleToPage: function(data){
      return get(APP_CONFIG.API_URL + `/api/article/GetArticlesToPage?user=cxk&category=${data.category}&startIndex=${data.startIndex}&length=${data.length}`);
    },
    //发布文章
